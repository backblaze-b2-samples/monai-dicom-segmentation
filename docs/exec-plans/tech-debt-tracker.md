...
- All screens — the app names itself "MONAI DICOM Segmentation" in the sidebar, header and breadcrumb while `README.md` titles the product "Vibe Coding Starter Kit", so the shipped name and the docs disagree
