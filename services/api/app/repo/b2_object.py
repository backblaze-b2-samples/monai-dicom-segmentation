...
def list_prefix_objects(prefix: str) -> list[dict]:
    ...
    Reads B2 directly (not the shared full-bucket cache) because study prefixes
...
def delete_prefix(prefix: str) -> int:
    ...
    SCOPED delete: callers MUST pass a concrete, non-empty study prefix such as
    `studies/<id>/`. An empty prefix would target the whole bucket, so it is
